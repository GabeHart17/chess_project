...
public class KnightRenderer extends PieceRenderer {
  private double[] xRatios = {0.25, 0.75, 0.75, 0.625, 0.875, 0.75, 0.25, 0.25, 0.5, 0.25};
  private double[] yRatios = {0.875, 0.875, 0.75, 0.75, 0.375, 0.125, 0.375, 0.5, 0.5, 0.75};
  double[] xRel = new double[yRatios.length];
  double[] yRel = new double[yRatios.length];
  public KnightRenderer (double size, Color color) {
    super(size, color);
